...
import { IconButton, Chip, Tooltip, MenuItem, ListItemIcon, ListItemText } from "@mui/material";
...
import {
  ...
  useCancelarPedidoMutation } from
      ...
      return (
        <>
            <Tooltip title="Ver Detalle">
              ...
              color="primary"
              onClick={() =>
              navigate(`/admin/pedidos/ver/${row.id_pedido}`, {
