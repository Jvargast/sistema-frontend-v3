...
import { DialogTitle, DialogContent, DialogActions, IconButton, List, ListItem, ListItemText, ListItemButton, Divider, ToggleButtonGroup, ToggleButton, Chip, Button } from "@mui/material";
        ...
        <List>
          ...
          <div key={caja.id_caja}>
                ...
                sx={{
                  ...
                  secondary={`Sucursal: ${
                  caja?.sucursal?.nombre || "N/A"} · Apertura: ${
